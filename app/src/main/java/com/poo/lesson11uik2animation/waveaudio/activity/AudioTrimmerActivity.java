package com.poo.lesson11uik2animation.waveaudio.activity;
...
import com.poo.lesson11uik2animation.waveaudio.MarkerView;
import com.poo.lesson11uik2animation.waveaudio.SamplePlayer;
import com.poo.lesson11uik2animation.waveaudio.SoundFile;
import com.poo.lesson11uik2animation.waveaudio.Utility;
import com.poo.lesson11uik2animation.waveaudio.WaveformView;
...
//                    handlePause();
    ...
    private void saveRingtone(final int finish) {
        ...
        Thread mSaveSoundFileThread = new Thread() {
            public void run() {
                // Try AAC first.
                String outPath = "/storage/emulated/0/Download/Tướng Quân.flac";
                if (outPath == null) {
